    ...
    return (
        <section id="about" className="bg-[#fcfcfb] dark:bg-[#1a1916] py-24 lg:py-32 transition-colors duration-300">
            <div className="container mx-auto px-6 lg:px-14">
                ...
                {/* Headline */}
                <h2 className="text-[40px] md:text-[56px] lg:text-[64px] leading-[1.05] tracking-[-0.03em] font-light text-[#0f0f0e] dark:text-[#f1ece4] m-0 mb-16 max-w-[720px] [text-wrap:balance]">
                    {language === 'zh' ? (
                        <>
                            誠信與專業，<br />
