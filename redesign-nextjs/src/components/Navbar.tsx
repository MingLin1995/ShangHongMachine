            ...
            <nav className={`fixed top-0 left-0 right-0 z-50 h-[76px] flex items-center justify-between px-6 lg:px-14 transition-all duration-200 ${scrolled
                ...
                <button onClick={scrollToTop} className="flex items-center gap-3 group">
                    ...
                    <span className="text-left leading-tight">
                        <span className="block font-semibold text-[16px] tracking-tight text-[#0f0f0e] dark:text-[#f1ece4]">上泓機械</span>
                        <span className="block font-light text-[11px] tracking-wide text-[#737370] dark:text-[#a8a39b] mt-0.5">SHANG HONG MACHINE</span>
                    </span>
                </button>
                ...
                <div className="hidden lg:flex items-center gap-7">
                    {links.map((l) => (
                        <button
                            key={l.id}
                            onClick={l.onClick}
                            className="text-[14px] font-normal text-[#3a3a36] dark:text-[#d1ccc4] hover:text-[#993333] dark:hover:text-[#ff9999] transition-colors duration-200"
                        >
                            {l.label}
                        </button>
                    ))}
                ...
                <div className="flex items-center gap-2.5">
                    <button
                        className="h-9 w-9 flex items-center justify-center rounded-full text-[#0f0f0e] dark:text-[#f1ece4] hover:bg-[#f7f6f3] dark:hover:bg-white/5 transition-colors"
                        onClick={toggleTheme}
                        aria-label="theme"
                    >
                        {theme === 'light' ? '☾' : '☀'}
                    ...
                    <button
                        className="px-4 py-2 rounded-full border border-[#0f0f0e] dark:border-white/20 text-[13px] font-medium text-[#0f0f0e] dark:text-[#f1ece4] hover:bg-[#f7f6f3] dark:hover:bg-white/5 transition-colors"
                    ...
                    <a
                        ...
                        download
                        className="hidden lg:inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-[#993333] hover:bg-[#7a2929] text-white text-[13px] font-medium transition-colors"
                    >
