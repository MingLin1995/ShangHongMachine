    ...
    return (
        <section id="contact" className="bg-[#f7f6f3] dark:bg-[#161412] py-24 transition-colors duration-300">
            <div className="container mx-auto px-6 lg:px-14">
                ...
                {/* Headline */}
                <h2 className="text-[40px] md:text-[48px] lg:text-[56px] leading-[1.05] tracking-[-0.025em] font-light text-[#0f0f0e] dark:text-[#f1ece4] m-0 mb-16 max-w-[720px] [text-wrap:balance]">
                    {language === 'zh' ? (
                        <>
                            歡迎來訊，<br />
